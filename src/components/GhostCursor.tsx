...
const GhostCursor: React.FC<GhostCursorProps> = ({
  ...
  useEffect(() => {
    ...
    parent.addEventListener('pointerenter', onPointerEnter as any, { passive: true });
    parent.addEventListener('pointerleave', onPointerLeave as any, { passive: true });
    ...
    return () => {
      ...
      parent.removeEventListener('pointerenter', onPointerEnter as any);
      parent.removeEventListener('pointerleave', onPointerLeave as any);
